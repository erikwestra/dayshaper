...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PreferenceSetting'
        db.create_table(u'shared_preferencesetting', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')()),
            ('value', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'shared', ['PreferenceSetting'])


    def backwards(self, orm):
        # Deleting model 'PreferenceSetting'
        db.delete_table(u'shared_preferencesetting')
    ...
    models = {
        ...
        u'shared.preferencesetting': {
            'Meta': {'object_name': 'PreferenceSetting'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

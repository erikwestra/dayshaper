...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.ordinal_rank'
        db.add_column(u'shared_task', 'ordinal_rank',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.ordinal_rank'
        db.delete_column(u'shared_task', 'ordinal_rank')
    ...
    models = {
        ...
        u'shared.task': {
            ...
            'ordinal_rank': ('django.db.models.fields.IntegerField', [], {}),
